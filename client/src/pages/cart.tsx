...
export default function Cart() {
  ...
  const submitQuote = useMutation({
    ...
    onSuccess: () => {
      ...
      clearCart();
      setCustomerInfo({ name: "", email: "", phone: "", company: "", message: "" });
    },
    onError: () => {
      toast({
        title: "Error",
      ...
      <div className="min-h-screen bg-gray-50 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="font-cinzel text-3xl font-bold text-gray-900 mb-4">Your Cart is Empty</h1>
            <p className="text-gray-600 mb-8">Add some products to request a quote</p>
    ...
    <div className="min-h-screen bg-gray-50 py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <h1 className="font-cinzel text-3xl font-bold text-gray-900 mb-8">Quote Request Cart</h1>
