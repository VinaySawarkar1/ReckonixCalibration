...
function resetAndAddRealProducts() {
    return __awaiter(this, void 0, void 0, function () {
        var _i, correctCategories_1, categoryData, category, allRealProducts, _a, allRealProducts_1, productData, product, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 12, 13, 15]);
                ...
                case 2:
                    ...
                    _i = 0, correctCategories_1 = correctCategories;
                    _b.label = 3;
                case 3:
                    if (!(_i < correctCategories_1.length)) return [3 /*break*/, 6];
                    categoryData = correctCategories_1[_i];
                    return [4 /*yield*/, prisma.category.create({
                            data: {
                                name: categoryData.name,
                                subcategories: {
                                    create: categoryData.subcategories.map(function (sub) { return ({ name: sub }); })
                                }
                            }
                        })];
                case 4:
                    category = _b.sent();
                    console.log("Created category: ".concat(category.name, " with ").concat(categoryData.subcategories.length, " subcategories"));
                    _b.label = 5;
                case 5:
                    _i++;
                    return [3 /*break*/, 3];
                ...
                case 7:
                    ...
                    allRealProducts = __spreadArray(__spreadArray([], unimetroProducts, true), polwaxProducts, true);
                    _a = 0, allRealProducts_1 = allRealProducts;
                    _b.label = 8;
                case 8:
                    if (!(_a < allRealProducts_1.length)) return [3 /*break*/, 11];
                    productData = allRealProducts_1[_a];
                    return [4 /*yield*/, prisma.product.create({
                            data: {
                                ...
                                imageUrl: "/uploads/products/default-".concat(productData.category.toLowerCase().replace(' ', '-'), ".jpg"),
                                homeFeatured: false,
                                rank: 0,
                                views: 0
                            }
                ...
                case 9:
                    product = _b.sent();
                    console.log("Created real product: ".concat(product.name));
                    _b.label = 10;
                case 10:
                    _a++;
                    return [3 /*break*/, 8];
                case 11:
                    ...
                    console.log("Created ".concat(correctCategories.length, " categories"));
                    console.log("Created ".concat(allRealProducts.length, " real products"));
                    return [3 /*break*/, 15];
                case 12:
                    error_1 = _b.sent();
                    console.error('Error resetting database and adding real products:', error_1);
                    return [3 /*break*/, 15];
